...
const pgData = [
    {
        ...
        title: "The Cover", //the title of the page (leaving this blank will default it to "Page X")
        date: writeDate(2023, 5, 19), //the date on which the page was posted (mainly for the archive). The date is written using a function called "writeDate", basically just put writeDate and then some parenthesis and, comma separated, the year followed by the month and the day. Don't forget another comma at the end outside the parenthesis!
        altText: "Cover Page", //the alt text (mouse over text) for this particular comic. put nothing inbetween the quotes for no alt text
        imageFiles: 1, //how many image files this page is split into
        authorNotes: `
            <p>Welcome to <b>Hellish Icon</b>! My name is <b>Trickertree</b>, you can call me Tree.</p>
            <p>I wanted to give an incredible special thanks to the people who could get me here. <b>Shoegomi</b> (Naoto) and <b>Fin Weber</b>, both have helped me with starting the process.</p>
            <p>--------------------------------------------------------------</p>
            <p>I love you guys thank you for helping me through all of this.</p>
            `,
    },
    {
        pgNum: 2,
        title: "COMING SOON",
        date: writeDate(2023, 5, 20),
        altText: "Coming Soon",
        imageFiles: 1,
        authorNotes: `
            <p> COMING SOON </p>
